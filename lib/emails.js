...
<p style="margin:0;">&mdash; Patience<br><span style="color:#666;font-size:14px;">Founder, Midly</span></p>`
  ...
  'Sprint Page': {
    ...
    body: (name) => `<p style="margin:0 0 16px;">Hi ${name || 'there'},</p>
<p style="margin:0 0 16px;">You're in. We'll send the sprint resources over the next few days &mdash; what to set up, what to skip, and how to get your contract process airtight, day by day.</p>
...
<p style="margin:0;">&mdash; Patience<br><span style="color:#666;font-size:14px;">Founder, Midly</span></p>`
  ...
  'Sprint CTA': {
    subject: 'Welcome to the Midly 5-Day Sprint',
    body: (name) => `<p style="margin:0 0 16px;">Hi ${name || 'there'},</p>
<p style="margin:0 0 16px;">Glad you're getting started. We'll send the sprint resources over the next few days &mdash; what to set up, what to skip, and how to get your contract process airtight, day by day.</p>
