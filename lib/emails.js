...
<p style="margin:0;">&mdash; Patience<br><span style="color:#666;font-size:14px;">Founder, Midly</span></p>`
  },
  'Q2 Sprint Page': {
    subject: 'Welcome to the Midly Q2 Sprint',
    body: (name) => `<p style="margin:0 0 16px;">Hi ${name || 'there'},</p>
<p style="margin:0 0 16px;">You're in. We'll send the Q2 Sprint resources over the next few days &mdash; what to set up, what to skip, and how to get your contract process airtight before quarter-end.</p>
...
<p style="margin:0;">&mdash; Patience<br><span style="color:#666;font-size:14px;">Founder, Midly</span></p>`
  ...
  'Q2 Sprint CTA': {
    subject: 'Welcome to the Midly Q2 Sprint',
    body: (name) => `<p style="margin:0 0 16px;">Hi ${name || 'there'},</p>
<p style="margin:0 0 16px;">Glad you're getting started. We'll send the Q2 Sprint resources over the next few days &mdash; what to set up, what to skip, and how to get your contract process airtight before quarter-end.</p>
...
<p style="margin:0;">&mdash; Patience<br><span style="color:#666;font-size:14px;">Founder &amp; Attorney, Midly</span></p>`
  },
  'Investor Inquiry': {
...
<p style="margin:0 0 24px;">In the meantime, our latest investor update and product walkthrough are available on request &mdash; just reply to this email.</p>
<p style="margin:0;">&mdash; Patience Babajide<br><span style="color:#666;font-size:14px;">Founder, Midly</span></p>`
  },
  'default': {
    subject: 'Thanks for reaching out — Midly',
    body: (name) => `<p style="margin:0 0 16px;">Hi ${name || 'there'},</p>
<p style="margin:0 0 24px;">Thanks for your message. We'll be in touch shortly.</p>
<p style="margin:0;">&mdash; The Midly team</p>`
  }
};
